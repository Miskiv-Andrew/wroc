        ...
        try:
            ...
            if mode == "RadDose":
                ...
                # ====================================================
                    ...
                    # ------------------------------------------------
                    # Обычный RadDose обновляет ТОЛЬКО оперативные
                    # параметры ZB.
                    #
                    # ВАЖНО:
                    #
                    # Здесь больше НЕ создаются:
                    #
                    #     ready_to_drain = 0
                    #     isotopes = нулевые значения
                    #
                    # Поэтому очередной PAED не уничтожает последний
                    # корректный результат спектрального анализа,
                    # ранее переданный в Bridge/PLC.
                    # ------------------------------------------------
